...
namespace HRMS.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        {
            var s15153Context = _context.Employee.Include(e => e.IdJobNavigation).Include(e => e.IdManagerNavigation);
        ...
        public async Task<IActionResult> Create([Bind("IdEmployee,FirstName,SecondName,LastName,Pesel,IdCardNumber,BirthDate,PhoneNumber,EmailAddress,Login,Password,Role,IdJob,IdManager")] Employee employee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdEmployee,FirstName,SecondName,LastName,Pesel,IdCardNumber,BirthDate,PhoneNumber,EmailAddress,Login,Password,Role,IdJob,IdManager")] Employee employee)
        {
